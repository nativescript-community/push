...
/**
 * Subscribe to the Pause and Resume activity events in order to toggle the
 * PushPlugin's status. When the Plugin is not in active state - i.e. at
 * foreground, notifications should be created and published in the Notification
